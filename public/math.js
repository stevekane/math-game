...
},{"./components/components.jsx":4,"socket.io-client":2}],4:[function(require,module,exports){
...
var createRoomTile = _.curry(function (context, clickHandler, room) {
  return (
  React.DOM.li( {className:"list-group-item", onClick:clickHandler.bind(context, room)}, 
  ...
  render: function () {
    ...
    React.DOM.nav( {className:"navbar navbar-inverse navbar-static-top", role:"navigation"}, 
      React.DOM.div( {className:"navbar-header"}, 
        ...
        React.DOM.p( {className:"navbar-text"}, "Welcome to hell, ", this.props.user.name)
      )
    ) 
    ); 
  },
